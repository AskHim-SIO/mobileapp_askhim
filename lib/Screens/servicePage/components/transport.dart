...
class TransportCard extends StatefulWidget {
  final int idS;
  const TransportCard({Key? key, required this.idS}) : super(key: key);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Point de Départ : " + snapshot.data!['pointDepart'],
                        softWrap: true,
                  ...
                  Padding(
                    ...
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "point d'Arriver : " + snapshot.data!['pointArriver'],
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.w600),
                      ),
                    ),
                    ...
                    child: Align(
                      ...
                      child: Text(
                        "Nombre de Place Disponible : " +
                            snapshot.data!['nbPlaceDispo'].toString(),
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.w600),
                      ),
                    ),
